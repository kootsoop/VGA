...
# ACDS 13.1 162 win32 2018.08.20.21:13:44
...
alias com {
  echo "\[exec\] com"
  vcom "$QSYS_SIMDIR/submodules/pll_altpll_0.vho" -work altpll_0
  vcom "$QSYS_SIMDIR/pll.vhd"                                   
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L altpll_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiii $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L altpll_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiii $TOP_LEVEL_NAME
}
